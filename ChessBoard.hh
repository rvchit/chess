...
namespace Student {
    ...
    public:
        ...
        /**
         * @brief Checks if the King of a specified color is currently in check.
         * 
         * This function iterates over all pieces on the board and determines if any opposing 
         * piece can move to the King's position, which would indicate that the King is in check.
         * 
         * @param color The color of the King to check (either White or Black).
